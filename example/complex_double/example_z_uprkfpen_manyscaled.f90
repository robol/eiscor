...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
program example_z_uprkfpen_manyscaled
...
!!$
  ...
  call z_uprk_compress(.TRUE.,.TRUE.,.TRUE.,.TRUE.,N,K,MA,MB,N,P,Q,&
...
end program example_z_uprkfpen_manyscaled
