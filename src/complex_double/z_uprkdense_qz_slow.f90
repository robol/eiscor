...
!
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine z_uprkdense_qz_slow(VECR,VECL,N,K,A,B,M,EIGSA,EIGSB,V,W,S,T,INFO)
...
!!$  end if  
  ...
  call z_uprk_compress_slow(.TRUE.,VECR,VECL,.TRUE.,N,K,A,B,M,P,Q,&
...
end subroutine z_uprkdense_qz_slow
